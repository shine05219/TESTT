<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyMenu.aspx.cs" Inherits="ModifyMenu" %>
...
<body bgcolor="#F5DEB3">
    ...
    <asp:Label ID="Label1" runat="server" Text="修改菜單" Font-Size="XX-Large" Font-Bold="True" ForeColor="#0066FF"></asp:Label>
    </div><br />

        <table border="1" class="auto-style2">
          <tr> 
              <td>
                  <asp:Label ID="Label2" runat="server" Text="編號 : "></asp:Label>
                  <asp:TextBox ID="TextBox6" runat="server"></asp:TextBox>
              </td>
              <td rowspan="6" class="auto-style4">
                    <asp:Label ID="Label9" runat="server" Text="圖片 : "></asp:Label>
                
                    <asp:Image ID="Image1" runat="server" Height="352px" ImageUrl="~/Image/亞米早餐.jpg" Width="364px" />
      ...
      <tr>
        ...
        <tr>
            <td> 
                <asp:Label ID="Label5" runat="server" Text="優惠 : "></asp:Label>
        ...
        <tr>
            <td>  
                <asp:Label ID="Label6" runat="server" Text="成本 : "></asp:Label>
      ...
      <tr> 
          <td class="auto-style3">
              <asp:Label ID="Label8" runat="server" Text="說明 : "></asp:Label>
