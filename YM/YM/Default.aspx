            ...
            <div style="display:table; position:relative;margin:0px auto;width:auto;height:100%;" >
                ...
                <form id="form1" runat="server" style=" display:table-row;height:100%;width:100%;margin:0px auto;">
                   <div class="auto-style2">
                    <div class="auto-style3" style="background-image:url('Image/login04.png');border-radius:30px;">
                        <img src="Image/Yummyv2.png" height="250" width="250" />
                            <span class="font1" style="display:inline-block;width:100%">
                        帳號：<asp:TextBox ID="TextBox1" runat="server" Height="16" ></asp:TextBox><br />
                        密碼：<asp:TextBox ID="TextBox2" runat="server" TextMode="Password" Height="16"></asp:TextBox>
                            </span>
                            <span class="font1" style="display:inline-block;line-height:70px;height:70px">
                                <asp:Button ID="Button1" runat="server" Text="確定" OnClick="Button1_Click" href="#" class="button button-pill button-flat-highlight" Width="130" Height="40"/>
                                <asp:Button ID="Button2" runat="server" Text="清除" OnClick="Button2_Click" href="#" class="button button-pill button-flat-highlight" Width="130" Height="40"/>
                                 <asp:Button ID="Button3" runat="server" Text="忘記密碼" OnClick="Button3_Click" href="#" class="button button-pill button-flat-highlight" Width="130" Height="40"/>
                            </span>
                    </div>
                   </div>
                </form>
