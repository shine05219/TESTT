...
public partial class ModifyMenu : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = null;
        conn.Open();
        cmd = new SqlCommand("INSERT INTO HotDessert (name,price,quantity,introduction,pictures,remarks) VALUES(@name,@price,@quantity, @introduction, @pictures,@remarks)", conn);
