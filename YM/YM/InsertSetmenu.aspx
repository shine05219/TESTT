<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InsertSetmenu.aspx.cs" Inherits="YM_InsertSivmenu" %>
...
<body bgcolor="#F5DEB3">
    ...
    <div style="text-align:center ;background-color:ghostwhite">
        ...
        <asp:Label ID="Label1" runat="server" Text="新增主餐" Font-Size="XX-Large" ForeColor="#3366FF" Font-Bold="True" Font-Names="微軟正黑體"></asp:Label>
    </div><br />
        ...
        <table border="1" class="auto-style2">
          <tr> 
              <td>
                  <asp:Label ID="Label2" runat="server" Text="主餐新增 : " Font-Names="微軟正黑體"></asp:Label>
                  </td>
                  <td rowspan="6">  
