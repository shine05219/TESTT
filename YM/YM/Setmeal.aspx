<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Setmeal.aspx.cs" Inherits="setmeal" %>
...
<body>
    ...
    <asp:Label ID="Label2" runat="server" Text="主餐" Font-Size="XX-Large" Font-Bold="True" ForeColor="#0066FF" Font-Names="微軟正黑體"></asp:Label>
    </div><br />
    ...
    <div  style="background-image: url('Image/ordermenu01.jpg');background-size:cover; background-repeat: no-repeat; background-position: center;" class="auto-style1">
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="Data Source=140.137.61.164;Initial Catalog=yummy;Persist Security Info=True;User ID=student;Password=student" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [SetMeal]"></asp:SqlDataSource>
