<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompleteOrder.aspx.cs" Inherits="YM_CompleteOrder" %>
...
<asp:Label ID="Label4" runat="server" Text="今日日期 : " ForeColor="#000099"></asp:Label>
                    ...
                    <div style="text-align:center ; font-family: Microsoft JhengHei;"> <asp:Label ID="Label3" runat="server" Text="已完成訂單" Font-Size="XX-Large"></asp:Label><br /><br />
        ...
        <asp:GridView ID="GridView3" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderStyle="None" DataKeyNames="ID" DataSourceID="SqlDataSource3" HorizontalAlign="Center" PageSize="5" Height="295px" Width="926px">
            <Columns>
