<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InsertVicmeal.aspx.cs" Inherits="YM_Insertvicmeal" %>
...
<body bgcolor="#F5DEB3">
    ...
    <asp:Label ID="Label1" runat="server" Text="新增副餐" Font-Size="XX-Large" ForeColor="#3366FF" Font-Bold="True" Font-Names="微軟正黑體"></asp:Label>
    </div><br />
        ...
        <table border="1" class="auto-style2">
          <tr> 
              <td>
                  <asp:Label ID="Label2" runat="server" Text="副餐新增 : " Font-Names="微軟正黑體"></asp:Label>
</td>
